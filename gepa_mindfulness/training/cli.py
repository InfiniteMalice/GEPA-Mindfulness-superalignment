...
if TYPE_CHECKING:  # pragma: no cover - import only for type checking
    from .pipeline import RolloutResult as _PipelineRolloutResult
else:  # pragma: no cover - runtime fallback when typing-only imports unavailable
    _PipelineRolloutResult = _RolloutLike

RolloutResult = _PipelineRolloutResult
...
RolloutIterable = Iterable[RolloutResult]
