...
def resolve_scenarios_path(scenarios_path: Optional[str] = None) -> Path:
...
def get_scenarios_path(scenarios_path: Optional[str] = None) -> str:
    """Compatibility wrapper that returns the scenarios path as a string."""

    return str(resolve_scenarios_path(scenarios_path))
