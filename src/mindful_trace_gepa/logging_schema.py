...
class StructuredEventType(str, Enum):
    ...
    SOT_STATE_SNAPSHOT = "sot_state_snapshot"
    SEMANTIC_STATE_CONTINUITY_ASSESSMENT = "semantic_state_continuity_assessment"
    EPISTEMIC_COMMITMENT = "epistemic_commitment"
    EPISTEMIC_CONTINUITY_ASSESSMENT = "epistemic_continuity_assessment"
    MOTIVATED_FORGETTING_ASSESSMENT = "motivated_forgetting_assessment"
